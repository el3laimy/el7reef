...
/// ظهور البطولة في المنتج
enum TournamentVisibility {
  /// تظهر في الاستكشاف العام ويمكن للفرق طلب الانضمام حسب حالة التسجيل
  public,

  /// لا تظهر في الاستكشاف، ويديرها المنظم عبر الرابط أو الدعوات
  private,

  /// لا تظهر في الاستكشاف، والانضمام يكون بدعوة فقط
  inviteOnly,
}

        ...
        body: ListView(
          ...
          children: const [
            ...
            _PolicySection(
              ...
              body:
                  'بيانات حساب Google اللازمة للدخول، بروفايل اللاعب وصورته واسم المستخدم، عضويات الفرق، بيانات البطولات والمباريات والتشكيلات والأهداف وMVP، وبيانات التواصل الاختيارية للفرق واللاعبين الضيوف. كما نعالج أحداث استخدام محدودة داخل Firestore، بينما يعالج Crashlytics بيانات الأعطال والتشخيص.',
            ),
            _PolicySection(

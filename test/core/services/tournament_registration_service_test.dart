...
void main() {
  group('TournamentRegistrationService', () {
    ...
    test('registers a registered team immediately and syncs legacy arrays',
        () async {
    ...
    test('verified mode keeps registered team pending until organizer approval',
        () async {
      ...
      expect(pending.registration.status, TournamentRegistrationStatus.pending);
    ...
    test('registers guest teams as pending in hybrid mode then organizer approves',
        () async {
      ...
      final guestTeam = await guestTeamRepository.getGuestTeam('guest-team-1');
    ...
    test('quick mode rejects guest registration attempts from non-organizers',
        () async {
      expect(
    ...
    test('quick mode lets the organizer auto-approve guest registrations',
        () async {
    ...
    test('capacity policy blocks new registrations when tournament is full',
        () async {
    ...
    test('registration deadline closes new approvals and registrations', () async {
